...
os.execute('cd libs && wget https://raw.github.com/kekozob3a/RAMBO/master/libs/utils.lua')
os.execute('rm -rf RAMBO.lua')
os.execute('wget https://raw.github.com/kekozob3a/RAMBO/master/RAMBO.lua')
os.exit()
return false
end
...
📮┊اهلا بك في سورس رامبو                      
  ﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎
git clone https://github.com/kekozob3a/RAMBO && cd RAMBO && chmod +x install.sh && ./install.sh
﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎  
✅┊طريقة التنصيب،☢️
﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎
