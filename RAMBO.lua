...
local keko_add_sudo = redis:get('RAMBO:'..bot_id..'sudoo'..msg.sender_user_id_..'')
...
h = http.request("http://api-victor.ml/keko/ads.php?get=RAMBO")
...
if text:match("^جلب المسجات الاصليه$") and is_creator(msg) and msg.reply_to_message_id_ ~= 0 then
function mute_by_reply(extra, result, success)
database:del('RAMBO:'..bot_id..'nummsg'..msg.chat_id_..result.sender_user_id_)
local user_msgs = database:get('RAMBO:'..bot_id..'user:msgs'..msg.chat_id_..':'..result.sender_user_id_)
...
return false end
if text:match("^(.*)$") then
local keko2 = redis:get('RAMBO:'..bot_id..'texts'..msg.sender_user_id_..'')
if keko2 == 'msg' then
...
local nkeko = redis:get('RAMBO:'..bot_id..'nmkeko')
local nakeko = redis:get('RAMBO:'..bot_id..'nakeko')
if text_sudo then
...
redis:set('RAMBO:'..bot_id..'nkeko'..msg.sender_user_id_..'', 'msg')
return false end
end
if text:match("^+(.*)$") then
local kekoo = redis:get('RAMBO:'..bot_id..'sudoo'..text..'')
local keko2 = redis:get('RAMBO:'..bot_id..'nkeko'..msg.sender_user_id_..'')
if keko2 == 'msg' then
send(msg.chat_id_, msg.id_, 1, '• `الان يمكنك ارسال الاسم الذي تريده` 📝', 1, 'md')
redis:set('RAMBO:'..bot_id..'nmkeko', text)
redis:set('RAMBO:'..bot_id..'nkeko'..msg.sender_user_id_..'', 'mmsg')
return false end
end
if text:match("^(.*)$") then
local keko2 = redis:get('RAMBO:'..bot_id..'nkeko'..msg.sender_user_id_..'')
...
redis:set('RAMBO:'..bot_id..'nkeko'..msg.sender_user_id_..'', 'no')
redis:set('RAMBO:'..bot_id..'nakeko', text)
local nmkeko = redis:get('RAMBO:'..bot_id..'nmkeko')
...
local keko = redis:get('RAMBO:'..bot_id..'keko'..text..''..msg.chat_id_..'')
if keko then 
...
local keko = redis:get('RAMBO:'..bot_id..'keko'..text..'')
if keko then 
function keko_RAMBO_re(t1,t2)
local user_msgs = database:get('RAMBO:'..bot_id..'user:msgs'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local edit = database:get('RAMBO:'..bot_id..'user:editmsg'..msg.chat_id_..':'..msg.sender_user_id_) or 0
...
redis:set('RAMBO:'..bot_id..'keko1'..msg.sender_user_id_..''..msg.chat_id_..'', 'msg')
return false end
if text:match("^(.*)$") then
local keko1 = redis:get('RAMBO:'..bot_id..'keko1'..msg.sender_user_id_..''..msg.chat_id_..'')
if keko1 == 'msg' then
...
redis:set('RAMBO:'..bot_id..'keko1'..msg.sender_user_id_..''..msg.chat_id_..'', 're')
...
redis:set('RAMBO:'..bot_id..'keko1'..msg.sender_user_id_..''..msg.chat_id_..'', 'nomsg')
return false end
if text:match("^(.*)$") then
local keko1 = redis:get('RAMBO:'..bot_id..'keko1'..msg.sender_user_id_..''..msg.chat_id_..'')
if keko1 == 'nomsg' then
send(msg.chat_id_, msg.id_, 1, '☑┇تم مسح الرد', 1, 'md')
redis:set('RAMBO:'..bot_id..'keko1'..msg.sender_user_id_..''..msg.chat_id_..'', 'no')
redis:del('RAMBO:'..bot_id..'keko'..text..''..msg.chat_id_..'')
...
redis:srem('RAMBO:'..bot_id..'kekore'..msg.chat_id_..'', text)
end
end
...
redis:set('RAMBO:'..bot_id..'keko1'..msg.sender_user_id_..'', 'msg')
return false end
local keko1 = redis:get('RAMBO:'..bot_id..'keko1'..msg.sender_user_id_..'')
if keko1 == 'msg' and text then
send(msg.chat_id_, msg.id_, 1, '📥┇الان ارسل الرد الذي تريد اضافته \n📥┇ قد يكون (ملف - فديو - نص - ملصق - بصمه - متحركه ) ', 1, 'md')
send(msg.chat_id_, msg.id_, 1,  '☑┇ يمكنك اضافه الى النص :\n- `#username` > اسم المستخدم\n- `#msgs` > عدد مسجات المستخدم\n- `#name` > اسم المستخدم\n- `#id` > ايدي المستخدم\n- `#stast` > موقع المستخدم \n- `#edit` > عدد التعديلات', 1, 'md')
redis:set('RAMBO:'..bot_id..'keko1'..msg.sender_user_id_..'', 're')
...
send(msg.chat_id_, msg.id_, 1, '💢┇ارسل الكلمه التي تريد مسحها' , 1, 'md')
redis:set('RAMBO:'..bot_id..'keko1'..msg.sender_user_id_..'', 'nomsg')
return false end
if text:match("^(.*)$") then
local keko1 = redis:get('RAMBO:'..bot_id..'keko1'..msg.sender_user_id_..'')
if keko1 == 'nomsg' then
send(msg.chat_id_, msg.id_, 1, '☑┇تم مسح الرد', 1, 'md')
redis:set('RAMBO:'..bot_id..'keko1'..msg.sender_user_id_..'', 'no')
...
redis:del('RAMBO:'..bot_id..'keko'..text)
redis:srem('RAMBO:'..bot_id..'kekoresudo', text)
end
end
...
local list = redis:smembers('RAMBO:'..bot_id..'kekore'..msg.chat_id_..'')
for k,v in pairs(list) do
redis:del('RAMBO:'..bot_id..'kekore'..msg.chat_id_..'', text)
redis:del('RAMBO:'..bot_id..'keko'..v..''..msg.chat_id_)
...
local list = redis:smembers('RAMBO:'..bot_id..'kekoresudo')
for k,v in pairs(list) do
redis:del('RAMBO:'..bot_id..'kekoresudo', text)
redis:del('RAMBO:'..bot_id..'keko'..v..'')
...
return false end
if text:match("^(.*)$") then
local keko2 = redis:get('RAMBO:'..bot_id..'hhh'..msg.sender_user_id_..'')
if keko2 == 'msg' then
send(msg.chat_id_, msg.id_, 1, '☑┇تم حفظ الكليشه يمكنك اظهارها بارسال الامر', 1, 'html')
...
if text == 'سمايلات' and database:get('RAMBO:'..bot_id..'lock_geam'..msg.chat_id_) then
database:del('RAMBO:'..bot_id..'l:ids'..msg.chat_id_)
katu = {'🍏','🍎','🍐','🍊','🍋','🍌','🍉','🍇','🍓','🍈','🍒','🍑','🍍','🥥','🥝','🍅','🍆','🥑','🥦','🥒','🌶','🌽','🥕','🥔','🍠','🥐','🍞','🥖','🥨','🧀','🥚','🍳','🥞','🥓','🥩','🍗','🍖','🌭','🍔','🍟','🍕','🥪','🥙','🍼','☕️','🍵','🥤','🍶','🍺','🍻','🏀','⚽️','🏈','⚾️','🎾','🏐','🏉','🎱','🏓','🏸','🥅','🎰','🎮','🎳','🎯','🎲','🎻','🎸','🎺','🥁','🎹','🎼','🎧','🎤','🎬','🎨','🎭','🎪','🎟','🎫','🎗','🏵','🎖','🏆','🥌','🛷','🚕','🚗','🚙','🚌','🚎','🏎','🚓','🚑','🚚','🚛','🚜','🇮🇶','⚔','🛡','🔮','🌡','💣','📌','📍','📓','📗','📂','📅','📪','📫','📬','📭','⏰','📺','🎚','☎️','📡'}
name = katu[math.random(#katu)]
database:set('RAMBO:'..bot_id..'klmos'..msg.chat_id_,name)
...
if text == ''..(database:get('RAMBO:'..bot_id..'klmos'..msg.chat_id_) or 'لفاتع')..'' and not database:get('RAMBO:'..bot_id..'l:ids'..msg.chat_id_) then
if not database:get('RAMBO:'..bot_id..'l:ids'..msg.chat_id_) then 
taha = '*📛¦ مبروك فزت \n📬¦ للعب مره اخره ارسل سمايلات*'
send(msg.chat_id_, msg.id_, 1,taha, 1, 'md')
database:incrby('RAMBO:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_, 1)  
database:incrby('RAMBO:'..bot_id..'add:numall'..msg.chat_id_..msg.sender_user_id_, 1)  

end
database:set('RAMBO:'..bot_id..'l:ids'..msg.chat_id_,true)
end 


if text == 'الاسرع' and database:get('RAMBO:'..bot_id..'lock_geam'..msg.chat_id_) then
database:del('RAMBO:'..bot_id..'l:id'..msg.chat_id_)
...
name = katu[math.random(#katu)]
database:set('RAMBO:'..bot_id..'klmo'..msg.chat_id_,name)
...
if text == ''..(database:get('RAMBO:'..bot_id..'klmo'..msg.chat_id_) or 'لفاتع')..'' and not database:get('RAMBO:'..bot_id..'l:id'..msg.chat_id_) then
if not database:get('RAMBO:'..bot_id..'l:id'..msg.chat_id_) then 
taha = '*💎¦ مبروك فزت \n📬¦ للعب مره اخره ارسل الاسرع*'
send(msg.chat_id_, msg.id_, 1,taha, 1, 'md')
database:incrby('RAMBO:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_, 1)
database:incrby('RAMBO:'..bot_id..'add:numall'..msg.chat_id_..msg.sender_user_id_, 1)    
end
database:set('RAMBO:'..bot_id..'l:id'..msg.chat_id_,true)
end 

if text == 'حزوره' and database:get('RAMBO:'..bot_id..'lock_geam'..msg.chat_id_) then
database:del('RAMBO:'..bot_id..'l:id1'..msg.chat_id_)
...
name = katu[math.random(#katu)]
database:set('RAMBO:'..bot_id..'klmoa'..msg.chat_id_,name)
...
if text == ''..(database:get('RAMBO:'..bot_id..'klmoa'..msg.chat_id_) or 'لفاتع')..'' and not database:get('RAMBO:'..bot_id..'l:id1'..msg.chat_id_) then
if not database:get('RAMBO:'..bot_id..'l:id1'..msg.chat_id_) then 
taha = '*💎¦ مبروك فزت \n📬¦ للعب مره اخره ارسل الاسرع*'
send(msg.chat_id_, msg.id_, 1,taha, 1, 'md')
database:incrby('RAMBO:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_, 1)
database:incrby('RAMBO:'..bot_id..'add:numall'..msg.chat_id_..msg.sender_user_id_, 1)    
end
database:set('RAMBO:'..bot_id..'l:id1'..msg.chat_id_,true)
end 


if text =='مجوهراتي' then 
if tonumber((database:get('RAMBO:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_) or 0)) == 0 then
taha = '*💎¦ ليس لديك مجوهرات \n📬¦ للحصول على مجوهرات ارسل الاسرع وابدأ اللعب*\n'
send(msg.chat_id_, msg.id_, 1,taha, 1, 'md')
else
taha = '*💎¦ عدد مجوهراتك الحاليه  ('..(database:get('RAMBO:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_))..')*'
taha1 = '*💎¦ مجموع مجوهراتك  ('..(database:get('RAMBO:'..bot_id..'add:numall'..msg.chat_id_..msg.sender_user_id_))..')*'
...
database:set('RAMBO:'..bot_id..'gamepoint' .. msg.chat_id_, kara[2] or 50)
...
taha = (database:get('RAMBO:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_) * tonumber(database:get('RAMBO:'..bot_id..'gamepoint' .. msg.chat_id_)or 50))
database:incrby('RAMBO:'..bot_id..'nummsg'..msg.chat_id_..msg.sender_user_id_,taha)  
database:del('RAMBO:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_)
taha = tonumber((database:get('RAMBO:'..bot_id..'gamepoint' .. msg.chat_id_) or 50))
...
send(msg.chat_id_, msg.id_, 1,taha, 1, 'md')
database:set('RAMBO:'..bot_id..'lock_geam'..msg.chat_id_,true)  
end
if text == 'تعطيل اللعبه' and is_owner(msg) then  
taha = '*📛¦*تم تعطيل اللعبه  ❌' 
send(msg.chat_id_, msg.id_, 1,taha, 1, 'md')
database:del('RAMBO:'..bot_id..'lock_geam'..msg.chat_id_) 
end
if text == 'تفعيل اللعبه' and is_owner(msg) then  
...
return false end
if text:match("^(.*)$") then
local keko2 = redis:get('RAMBO:'..bot_id..'h11'..msg.sender_user_id_..'')
if keko2 == 'msg' then
send(msg.chat_id_, msg.id_, 1, '☑┇تم حفظ الكليشه يمكنك اظهارها بارسال الامر', 1, 'html')
...
return false end
if text:match("^(.*)$") then
local keko2 = redis:get('RAMBO:'..bot_id..'h22'..msg.sender_user_id_..'')
if keko2 == 'msg' then
send(msg.chat_id_, msg.id_, 1, '☑┇تم حفظ الكليشه يمكنك اظهارها بارسال الامر', 1, 'html')
...
return false end
if text:match("^(.*)$") then
local keko2 = redis:get('RAMBO:'..bot_id..'h33'..msg.sender_user_id_..'')
if keko2 == 'msg' then
send(msg.chat_id_, msg.id_, 1, '☑┇تم حفظ الكليشه يمكنك اظهارها بارسال الامر', 1, 'html')
...
return false end
if text:match("^(.*)$") then
local keko2 = redis:get('RAMBO:'..bot_id..'h44'..msg.sender_user_id_..'')
if keko2 == 'msg' then
send(msg.chat_id_, msg.id_, 1, '☑┇تم حفظ الكليشه يمكنك اظهارها بارسال الامر', 1, 'html')
...
👨‍🔧|℡<a href="https://t.me/th3victory">مطورين السورس👨‍🔧</a>
 
👨‍🔧|℡<a href="t.me/RAMBO_SYR">RAMI○•</a>


👨‍🔧|℡<a href="t.me/ramixnxx_bot">TW BOT○•</a> 
]]
send(msg.chat_id_, msg.id_, 1, text, 1, 'html')
end
...
local keko1 = redis:get('RAMBO:'..bot_id..'keko1'..msg.sender_user_id_..''..msg.chat_id_..'')
if keko1 == 're' then
local keko2 = redis:get('RAMBO:'..bot_id..'msg'..msg.sender_user_id_..''..msg.chat_id_..'')
if text then 
redis:set('RAMBO:'..bot_id..'keko'..keko2..''..msg.chat_id_..'', text)
elseif (data.message_.content_.sticker_) then 
redis:set('RAMBO:'..bot_id..':sticker:'..keko2..''..msg.chat_id_..'', data.message_.content_.sticker_.sticker_.persistent_id_)
elseif (data.message_.content_.voice_) then 
redis:set('RAMBO:'..bot_id..':voice:'..keko2..''..msg.chat_id_..'', data.message_.content_.voice_.voice_.persistent_id_)
elseif (data.message_.content_.video_) then 
redis:set('RAMBO:'..bot_id..':video:'..keko2..''..msg.chat_id_..'', data.message_.content_.video_.video_.persistent_id_)
elseif (data.message_.content_.animation_) then 
redis:set('RAMBO:'..bot_id..':gif:'..keko2..''..msg.chat_id_..'', data.message_.content_.animation_.animation_.persistent_id_)
elseif (data.message_.content_.document_) then
redis:set('RAMBO:'..bot_id..':file:'..keko2..''..msg.chat_id_..'', data.message_.content_.document_.document_.persistent_id_)
else
end -- end if text 
redis:sadd('RAMBO:'..bot_id..'kekore'..msg.chat_id_..'', keko2)
send(msg.chat_id_, msg.id_, 1, "☑┇تم حفظ الرد", 1, 'md')
redis:set('RAMBO:'..bot_id..'keko1'..msg.sender_user_id_..''..msg.chat_id_..'', 'no')
end
local keko1 = redis:get('RAMBO:'..bot_id..'keko1'..msg.sender_user_id_..'')
if keko1 == 're' then
local keko2 = redis:get('RAMBO:'..bot_id..'msg'..msg.sender_user_id_..'')
if text then 
redis:set('RAMBO:'..bot_id..'keko'..keko2..'', text)
elseif (msg.content_.sticker_) then 
redis:set('RAMBO:'..bot_id..':sticker:'..keko2, msg.content_.sticker_.sticker_.persistent_id_)
elseif (msg.content_.voice_) then 
redis:set('RAMBO:'..bot_id..':voice:'..keko2, msg.content_.voice_.voice_.persistent_id_)
elseif (msg.content_.video_) then 
redis:set('RAMBO:'..bot_id..':video:'..keko2, msg.content_.video_.video_.persistent_id_)
elseif (msg..content_.animation_) then 
redis:set('RAMBO:'..bot_id..':gif:'..keko2, data.message_.content_.animation_.animation_.persistent_id_)
elseif (msg.content_.document_) then
redis:set('RAMBO:'..bot_id..':file:'..keko2, msg.content_.document_.document_.persistent_id_)
end
redis:sadd('RAMBO:'..bot_id..'kekoresudo', keko2)
send(msg.chat_id_, msg.id_, 1, "☑┇تم حفظ الرد", 1, 'md')
redis:set('RAMBO:'..bot_id..'keko1'..msg.sender_user_id_..'', 'no')
end
--         »»                 Run RAMBO                         ««              --
