...
send(msg.chat_id_, msg.id_, 1, '- آرسہل آلآنہ نہصہ آوٌ مہيہديہآ 📢:
{صہوٌرهہ - فيہديہوٌ - مہتحہركهہ - مہلفہ}', 1, 'md')
...
👨‍🔧|℡<a href="t.me/RAMBO_SYR">مطور السورس👨‍🔧</a>
 
👨‍🔧|℡<a href="t.me/hdhul">الخال○•</a>

👨‍🔧|℡<a href="t.me/SAHER_SYR">SAHER○•</a>

🌐|℡<a href="https://github.com/ramizob3a/RAMBO">رابط السورس⛓</a> 
]]
send(msg.chat_id_, msg.id_, 1, text, 1, 'html')
end
...
gpss = database:smembers( 'RAMBO:'..bot_id.."groups") or 0
send(msg.chat_id_, msg.id_, 1, '♪تمہ آلنشہر بنجآحہ فيہ {'..(#gpss - pro)..'} مجہموٌعهہ ', 1, 'md')
end
end
local keko1 = redis:get('RAMBO:'..bot_id..'keko1'..msg.sender_user_id_..''..msg.chat_id_..'')
if keko1 == 're' then
