...
send(msg.chat_id_, msg.id_, 1, "☑┇رح اروح بحبكن♥", 1, 'md')
else
end
end
...
tsX000("prore",msg,"🔲 العضو بلفعل تـم ترقـيته ليصبح منشئ في المجموعة ✔️")
else
database:sadd(hash, result.sender_user_id_)
tsX000("prore",msg,"🔳 العـضو 💳 
...
tsX000(apow[2],msg,"🔲 تـم تنزيله من  منـشئٰين المجموعة ✔️")
end--
...
send(msg.chat_id_, msg.id_, 1, '💢┇اهلا عزيزي المطور تم تحديث البوت', 1, 'md')
...
if database:sismember(hash, result.sender_user_id_) then
tsX000("prore",msg,'🔲 العضو بلفعل تـم ترقـيته ليصبح أدمـن في المجموعة ✔️')
else
database:sadd(hash, result.sender_user_id_)
tsX000("prore",msg,'
...
if database:sismember(hash, result.sender_user_id_) then
tsX000("prore",msg,"🔲 بلفعل تـم ترقـيته ليصبح مميز في المجموعة ✔️") 
else
database:sadd(hash, result.sender_user_id_)
tsX000("prore",msg,"🔲 تـم ترقـيته وأصبح مميز في المجموعة ✔️")
end
end
getMessage(msg.chat_id_, msg.reply_to_message_id_,promote_by_reply)
end
...
texts = '🔳 العـضو 💳 ⌁≻ ['..result.title_..'](t.me/'..(apmd[2] or 'TH3VICTORY')..')\n🔲 تـم ترقـيته وأصبح مميز في المجموعة ✔️'
else
texts = '✖┇خطاء'
end
send(msg.chat_id_, msg.id_, 1, texts, 1, 'md')
...
tsX000(apmd[2],msg,"🔲 بلفعل تـم ترقـيته ليصبح مميز في المجموعة ✔️")
end
...
local hash =  'RAMBO:'..bot_id..'vipgp:'..msg.chat_id_
if not database:sismember(hash, result.sender_user_id_) then
send(msg.chat_id_, msg.id_, 1, '🔳 العـضو 💳 ⌁≻ *('..result.sender_user_id_..')* \n 💢┇🔲 تـم تنزيله من مميزين المجموعة ✔️', 1, 'md')
tsX000("prore",msg,"🔲 بلفعل تـم تنزيله من مميزين المجموعة ✔️")  
else
database:srem(hash, result.sender_user_id_)
tsX000("prore",msg,"🔲 تـم تنزيله من مميزين المجموعة ✔️")
end
end
getMessage(msg.chat_id_, msg.reply_to_message_id_,demote_by_reply)
end
...
database:srem(hash, result.id_)
texts = '🔳 العـضو 💳 ⌁≻ ['..result.title_..'](t.me/'..(apmd[2] or 'TH3VICTORY')..')\n🔳 العـضو 💳 
🔲 تـم تنزيله من مميزين المجموعة ✔️'
else
texts = '✖┇خطاء'
end
send(msg.chat_id_, msg.id_, 1, texts, 1, 'md')
...
database:srem(hash, apmd[2])
tsX000(apmd[2],msg,"🔲 تـم تنزيله من مميزين المجموعة ✔️")
end  
...
if database:sismember(hash, result.sender_user_id_) then
tsX000("prore",msg,"🔲 بلفعل تـم ترقـيته ليصبح إداري في المجموعة ✔️")
else
database:sadd(hash, result.sender_user_id_)
tsX000("prore",msg,"🔲 تـم ترقـيته وأصبح إداري في المجموعة ✔️")
end
end
...
texts = '🔳 العـضو 💳 ⌁≻ ['..result.title_..'](t.me/'..(apow[2] or 'TH3VICTORY')..')\n🔲 تـم ترقـيته وأصبح إداري في المجموعة ✔️'
else
texts = '✖┇خطاء'
end
send(msg.chat_id_, msg.id_, 1, texts, 1, 'md')
...
tsX000(apow[2],msg,"🔲 تـم ترقـيته وأصبح إداري في المجموعة ✔️")
end  
if text:match("^تنزيل اداري$") and is_creator(msg) and msg.reply_to_message_id_ then
function deowner_by_reply(extra, result, success)
local hash =  'RAMBO:'..bot_id..'owners:'..msg.chat_id_
if not database:sismember(hash, result.sender_user_id_) then
tsX000("prore",msg,"🔲 بلفعل تـم تنزيله من إداريين المجموعة ✔️")
else
database:srem(hash, result.sender_user_id_)
tsX000("prore",msg,"🔲 تـم تنزيله من إداريين المجموعة ✔️")
end
end
...
if result.id_ then
database:srem(hash, result.id_)
texts = '🔳 العـضو 💳 ⌁≻ ['..result.title_..'](t.me/'..(apow[2] or 'TH3VICTORY')..')\n🔲 تـم تنزيله من إداريين المجموعة ✔️'
else
texts = '✖┇خطاء'
end
send(msg.chat_id_, msg.id_, 1, texts, 1, 'md')
...
database:srem(hash, apow[2])
tsX000(apow[2],msg,"🔲 تـم تنزيله من إداريين المجموعة ✔️")
end
...
tsX000("prore",msg,'🔲 بلفعل تـم ترقـيته ليصبح مُبرمـج في البوت ✔️')
else
redis:set('RAMBO:'..bot_id..'sudoo'..result.sender_user_id_..'', 'yes')
redis:sadd('RAMBO:'..bot_id..'dev', result.sender_user_id_)
tsX000("prore",msg,'🔲 تـم ترقـيته وأصبح مُبرمـج في البوت ✔️')
end
end
getMessage(msg.chat_id_, msg.reply_to_message_id_,promote_by_reply)
end
...
texts = '🔳 العـضو 💳 ⌁≻ ['..result.title_..'](t.me/'..(apmd[2] or 'TH3VICTORY')..')\n\n🔲 تـم ترقـيته وأصبح مُبرمـج في البوت ✔️'
else
texts = '✖┇خطاء'
end
send(msg.chat_id_, msg.id_, 1, texts, 1, 'md')
...
tsX000(apmd[2],msg,'🔲 تـم ترقـيته وأصبح مُبرمـج في البوت ✔️')
end
...
texts = '🔳 العـضو 💳  ['..result.title_..'](t.me/'..(apmd[2] or 'TH3VICTORY')..')\n🔲 تـم تنزيله من مُبرمـجين البوت ✔️'
else
texts = '✖┇خطاء'
end
send(msg.chat_id_, msg.id_, 1, texts, 1, 'md')
...
tsX000(apmd[2],msg,'🔲 تـم تنزيله من مُبرمـجين البوت ✔️')
end
...
local keko_text = {
"رجع صورتك القديمه طالع متل الطنطات😹",
...
if text:match("^اصدار$") or text:match("^رامبو$") or text:match("^السورس$") or text:match("^سورس$") then
local text =  [[
{اهلا بك في سورس رامبو RAMBO تابع قنوات السورس } ~》
