...
info = '👨🏻‍🎤┇عزيزي المبرمج ⌁≻ ['..result.first_name_..'](t.me/'..(result.username_ or 'th3victory')..')\n'
...
send(msg.chat_id_, msg.id_, 1, '🖲┇ تم تعطيل ضهور الاعلانات لمده يوم \n📊┇ [يمكنك يوزره المزيد حول الاعلانات هنا](https://t.me/RAMBOADS)', 1, "md") 
else
...
sendContact(msg.chat_id_, msg.id_, 0, 1, nil, (nkeko or 9647723177600), (nakeko or "RAMBO TEAM"), "", bot_id)
end
end
for k,v in pairs(sudo_users) do
