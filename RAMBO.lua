...
send(msg.chat_id_, msg.id_, 1, '📭¦ حسننا الان ارسل الكليشه للاذاعه 
🔛', 1, 'md')
...
send(msg.chat_id_, msg.id_, 1, '- اذاعه البوت بلفعل تم تفعيلها 📢', 1, 'md')
else
...
send(msg.chat_id_, msg.id_, 1, '💢┇بلفعل تم تعطيل اذاعه البوت', 1, 'md')
